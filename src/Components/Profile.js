...
import Resume from "../Components/Vedant_FS_Resume.pdf";
    ...
    <div className="profile-bio" id="home">
      <div className="portfolio-container">
        ...
        <div className="bio">
          ...
          <h4 className="coffee-description">
            You either see me drinking Coffee or see me holding one ☕️
          </h4>
          <button class="btn-82" onClick={downloadResume}>
      ...
      <div className="social-links">
        <a
          href="https://github.com/Vedant09"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/vedant-yelsangikar"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="https://twitter.com/vedantvy"
          target="_blank"
          rel="noopener noreferrer"
        >
